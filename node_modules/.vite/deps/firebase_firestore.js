...
var dt = class {
  ...
  isEqual(t2) {
    return 0 === dt.comparator(this, t2);
  }
  child(t2) {
...
function At(t2) {
  return "string" == typeof t2 ? pt.fromBase64String(t2) : pt.fromUint8Array(t2);
}
function Rt(t2) {
  var e, n;
...
var xt = class {
  ...
  isEqual(t2) {
    return null !== t2 && 0 === _t.comparator(this.path, t2.path);
  }
  toString() {
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (ht(n2) !== ht(s))
          return false;
        for (const t4 in n2)
          if (n2.hasOwnProperty(t4) && (void 0 === s[t4] || !Ot(n2[t4], s[t4])))
            return false;
        return true;
      }(t2, e);
    default:
...
function Ft(t2, e) {
  return void 0 !== (t2.values || []).find((t3) => Ot(t3, e));
}
function $t(t2, e) {
  if (t2 === e)
    return 0;
...
function Jt(t2, e) {
  return void 0 === t2 ? e : void 0 === e || $t(t2, e) > 0 ? t2 : e;
}
function Yt(t2, e) {
  return void 0 === t2 ? e : void 0 === e || $t(t2, e) < 0 ? t2 : e;
}
...
function oe(t2, e) {
  const n = t2.toTimestamp().seconds, s = t2.toTimestamp().nanoseconds + 1, i = ct.fromTimestamp(1e9 === s ? new at(n + 1, 0) : new at(n, s));
...
function ce(t2, e) {
  ...
  return 0 !== n ? n : (n = xt.comparator(t2.documentKey, e.documentKey), 0 !== n ? n : rt(t2.largestBatchId, e.largestBatchId));
}
var he = class {
...
function we(t2) {
  return xt.isDocumentKey(t2.path) && null === t2.collectionGroup && 0 === t2.filters.length;
}
function me(t2, e) {
...
var ge = class extends class {
  ...
  static create(t2, e, n) {
    return t2.isKeyField() ? "in" === e || "not-in" === e ? this.V(t2, e, n) : new ye(t2, e, n) : "array-contains" === e ? new Ee(t2, n) : "in" === e ? new Ae(t2, n) : "not-in" === e ? new Re(t2, n) : "array-contains-any" === e ? new be(t2, n) : new ge(t2, e, n);
  }
  static V(t2, e, n) {
    return "in" === e ? new pe(t2, n) : new Ie(t2, n);
  }
  matches(t2) {
    const e = t2.data.field(this.field);
    return "!=" === this.op ? null !== e && this.v($t(e, this.value)) : null !== e && Mt(this.value) === Mt(e) && this.v($t(e, this.value));
  }
  v(t2) {
    switch (this.op) {
      case "<":
...
function Te(t2, e) {
  var n;
  return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((t3) => xt.fromName(t3.referenceValue));
}
...
function Qe(t2, e) {
  return e.isFoundDocument() && function(t3, e2) {
    const n = e2.key.path;
    return null !== t3.collectionGroup ? e2.key.hasCollectionId(t3.collectionGroup) && t3.path.isPrefixOf(n) : xt.isDocumentKey(t3.path) ? t3.path.isEqual(n) : t3.path.isImmediateParentOf(n);
  }(t2, e) && function(t3, e2) {
...
function ze(t2, e, n) {
  const s = t2.field.isKeyField() ? xt.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return null !== s2 && null !== i ? $t(s2, i) : L2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return s;
...
function In(t2, e) {
  return t2.type === e.type && (!!t2.key.isEqual(e.key) && (!!t2.precondition.isEqual(e.precondition) && (!!function(t3, e2) {
    return void 0 === t3 && void 0 === e2 || !(!t3 || !e2) && ot(t3, e2, (t4, e3) => fn(t4, e3));
...
var Fn = class {
  constructor(t2, e, n, s, i) {
    this.key = t2, this.value = e, this.color = null != n ? n : Fn.RED, this.left = null != s ? s : Fn.EMPTY, this.right = null != i ? i : Fn.EMPTY, this.size = this.left.size + 1 + this.right.size;
  }
  copy(t2, e, n, s, i) {
    return new Fn(null != t2 ? t2 : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
  }
  isEmpty() {
    return false;
  }
    ...
    this.st.forEach((n2, s2) => {
      ...
      if (i) {
        if (n2.current && we(i.target)) {
          ...
          null !== this.it.get(e2) || this.It(s2, e2) || this.ct(s2, e2, te.newNoDocument(e2, t2));
        }
...
function Rs(t2, e) {
  ...
  if ("targetChange" in e) {
    ...
    const s = function(t3) {
      ...
      return t3.N ? (U2(void 0 === e2 || "string" == typeof e2), pt.fromBase64String(e2 || "")) : (U2(void 0 === e2 || e2 instanceof Uint8Array), pt.fromUint8Array(e2 || new Uint8Array()));
    }(t2, e.targetChange.resumeToken), o = e.targetChange.cause, u = o && function(t3) {
      const e2 = void 0 === t3.code ? K2.UNKNOWN : Nn(t3.code);
...
function Ps(t2, e) {
  const n = e.currentDocument ? function(t3) {
    return void 0 !== t3.updateTime ? _n.updateTime(fs(t3.updateTime)) : void 0 !== t3.exists ? _n.exists(t3.exists) : _n.none();
  }(e.currentDocument) : _n.none(), s = e.updateTransforms ? e.updateTransforms.map((e2) => function(t3, e3) {
    let n2 = null;
    if ("setToServerValue" in e3)
      U2("REQUEST_TIME" === e3.setToServerValue), n2 = new nn();
...
function Ss(t2, e) {
  ...
  null !== e.collectionGroup ? (n.parent = gs(t2, s), n.structuredQuery.from = [{
...
function Ds(t2) {
  ...
  n.limit && (u = function(t3) {
    let e2;
    return e2 = "object" == typeof t3 ? t3.value : t3, St(e2) ? null : e2;
  }(n.limit));
  let a = null;
...
function xs(t2) {
  return t2 ? void 0 !== t2.unaryFilter ? [$s(t2)] : void 0 !== t2.fieldFilter ? [Fs(t2)] : void 0 !== t2.compositeFilter ? t2.compositeFilter.filters.map((t3) => xs(t3)).reduce((t3, e) => t3.concat(e)) : L2() : [];
}
function Ns(t2) {
  return os[t2];
}
...
var gi = class {
  constructor(t2, e, n) {
    ...
    12.2 === gi.Vt(getUA()) && F2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  static delete(t2) {
  ...
  static St() {
    var t2;
    return "undefined" != typeof process && "YES" === (null === (t2 = process.env) || void 0 === t2 ? void 0 : t2.Ct);
  }
  static xt(t2, e) {
    return t2.store(e);
  }
  ...
  async Nt(t2) {
    return this.db || (O2("SimpleDb", "Opening database:", this.name), this.db = await new Promise((e, n) => {
      ...
      s.onsuccess = (t3) => {
        ...
        "VersionError" === s2.name ? n(new Q2(K2.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s2.name ? n(new Q2(K2.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s2)) : n(new pi(t2, s2));
...
var Ti = class {
  ...
  put(t2, e) {
    let n;
    return void 0 !== e ? (O2("SimpleDb", "PUT", this.store.name, t2, e), n = this.store.put(e, t2)) : (O2("SimpleDb", "PUT", this.store.name, "<auto-key>", t2), n = this.store.put(t2)), Ei(n);
  }
  add(t2) {
  ...
  get(t2) {
    return Ei(this.store.get(t2)).next((e) => (void 0 === e && (e = null), O2("SimpleDb", "GET", this.store.name, t2, e), e));
  }
  delete(t2) {
  ...
  Gt(t2, e) {
    ...
    return new wi((s, i) => {
      t2.onerror = (t3) => {
        ...
        r.isDone ? s() : null === r.Lt ? i2.continue() : i2.continue(r.Lt);
      };
    }).next(() => wi.waitFor(n));
  }
  options(t2, e) {
...
function $i(t2) {
  const e = Oi(t2.readTime), n = void 0 !== t2.lastLimboFreeSnapshotVersion ? Oi(t2.lastLimboFreeSnapshotVersion) : ct.min();
  let s;
  var i;
  return void 0 !== t2.query.documents ? (U2(1 === (i = t2.query).documents.length), s = Le(Ne(ys(i.documents[0])))) : s = function(t3) {
    return Le(Ds(t3));
...
function Li(t2) {
  ...
  return "LAST" === t2.limitType ? Ue(e, e.limit, "L") : e;
}
function Ui(t2, e) {
...
var Yi = class {
  ...
  ge(t2) {
    const e = 255 & t2;
    0 === e ? (this.ve(0), this.ve(255)) : 255 === e ? (this.ve(255), this.ve(0)) : this.ve(t2);
  }
  we() {
    this.Pe(0), this.Pe(1);
  }
...
function nr(t2, e) {
  ...
  return 0 !== n ? n : (n = sr(t2.arrayValue, e.arrayValue), 0 !== n ? n : (n = sr(t2.directionalValue, e.directionalValue), 0 !== n ? n : xt.comparator(t2.documentKey, e.documentKey)));
}
function sr(t2, e) {
...
var ir = class {
  constructor(t2) {
    this.collectionId = null != t2.collectionGroup ? t2.collectionGroup : t2.path.lastSegment(), this.Me = t2.orderBy, this.Oe = [];
    for (const e of t2.filters) {
      const t3 = e;
...
var ar = class {
  ...
  ze(t2, e, n, s, i, r, o) {
    ...
    for (let h = 0; h < u; ++h) {
      ...
      c.push(...this.createRange(l2, f, o.map((e2) => this.Je(
        t2,
        u2,
        e2,
        true
  ...
  je(t2, e, n) {
    return null == n ? null : this.We(t2, e, n.position);
  }
  nn(t2) {
    const e = [];
    for (let n = 0; n < t2.length; ++n)
  ...
  getNextCollectionGroupToUpdate(t2) {
    return this.getFieldIndexes(t2).next((t3) => 0 === t3.length ? null : (t3.sort((t4, e) => {
      ...
      return 0 !== n ? n : rt(t4.collectionGroup, e.collectionGroup);
  ...
  createRange(t2, e, n) {
    n = n.sort((t3, e2) => nr(t3, e2)).filter((t3, e2, n2) => !e2 || 0 !== nr(t3, n2[e2 - 1]));
    const s = [];
    s.push(t2);
    for (const i2 of n) {
...
var Ar = class {
  ...
  removeMatchingKeysForTargetId(t2, e) {
    const n = Pr(t2), s = IDBKeyRange.bound(
      [e],
      [e + 1],
      false,
      true
...
var Dr = class {
  ...
  start(t2) {
    -1 !== this.garbageCollector.params.cacheSizeCollectionThreshold && this.vn(t2);
  }
  stop() {
...
var Cr = class {
  ...
  collect(t2, e) {
    return -1 === this.params.cacheSizeCollectionThreshold ? (O2("LruGarbageCollector", "Garbage collection skipped; disabled"), wi.resolve(dr)) : this.getCacheSize(t2).next((n) => n < this.params.cacheSizeCollectionThreshold ? (O2("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), dr) : this.xn(t2, e));
  }
  getCacheSize(t2) {
...
var xr = class {
  ...
  kn(t2, e) {
    ...
    return n.Wt({
      ...
      0 === t3 ? (i !== nt.A && e(new xt(Ks(s)), i), i = o, s = r) : i = nt.A;
    }).next(() => {
...
var kr = class {
  ...
  getEntry(t2, e) {
    ...
    return void 0 !== n ? wi.resolve(n) : this.getFromCache(t2, e);
  }
  getEntries(t2, e) {
...
function Ur(t2, e) {
  ...
  return 0 !== n ? n : xt.comparator(t2, e);
}
var qr = class {
  constructor(t2) {
    this.M = t2;
...
var Qr = class {
  constructor(t2, e, n, s, i, r, o, u, a, c, h = 13) {
    ...
    this.referenceDelegate = new xr(this, s), this.cs = e + "main", this.M = new Ci(u), this.hs = new gi(this.cs, this.Zn, new qr(this.M)), this.ls = new Ar(this.referenceDelegate, this.M), this.fs = function(t3) {
      return new Mr(t3);
    }(this.M), this.ds = new Gi(), this.window && this.window.localStorage ? this._s = this.window.localStorage : (this._s = null, false === c && F2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  start() {
    return this.ws().then(() => {
  ...
  async Vs() {
    if (this.isPrimary && !this.vs(this.os, 18e5)) {
      ...
      const t2 = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t3) => {
        ...
        return e.qt().next((t4) => {
          const n = this.Ss(t4, 18e5), s = t4.filter((t5) => -1 === n.indexOf(t5));
  ...
  Es(t2) {
    ...
    return jr(t2).get("owner").next((e) => {
      ...
      return !(!this.networkEnabled || !this.inForeground) || Wr(t2).qt().next((t3) => void 0 === this.Ss(t3, 5e3).find((t4) => {
  ...
  runTransaction(t2, e, n) {
    ...
    const s = "readonly" === e ? "readonly" : "readwrite", i = 14 === (r = this.Zn) ? fi : 13 === r ? li : 12 === r ? hi : 11 === r ? ci : void L2();
    var r;
    let o;
    return this.hs.runTransaction(t2, s, i, (s2) => (o = new bi(s2, this.ts ? this.ts.next() : nt.A), "readwrite-primary" === e ? this.Ts(o).next((t3) => !!t3 || this.Es(o)).next((e2) => {
      if (!e2)
  ...
  Fs(t2) {
    return jr(t2).get("owner").next((t3) => {
      if (null !== t3 && this.vs(t3.leaseTimestampMs, 5e3) && !this.Cs(t3.ownerId) && !this.bs(t3) && !(this.Xn || this.allowTabSynchronization && t3.allowTabSynchronization))
        throw new Q2(K2.FAILED_PRECONDITION, Kr);
    });
  }
  Rs(t2) {
  ...
  gs() {
    null !== this.document && "function" == typeof this.document.addEventListener && (this.ss = () => {
      this.Jn.enqueueAndForget(() => (this.inForeground = "visible" === this.document.visibilityState, this.ws()));
  ...
  ys() {
    var t2;
    "function" == typeof (null === (t2 = this.window) || void 0 === t2 ? void 0 : t2.addEventListener) && (this.ns = () => {
  ...
  Cs(t2) {
    var e;
    try {
      const n = null !== (null === (e = this._s) || void 0 === e ? void 0 : e.getItem(this.Ds(t2)));
...
var Hr = class {
  ...
  Ks(t2, e, n) {
    return function(t3) {
      return xt.isDocumentKey(t3.path) && null === t3.collectionGroup && 0 === t3.filters.length;
    ...
    return this.fs.getAllFromCollection(t2, e.path, n).next((n2) => (s = n2, this.$s.getAllMutationBatchesAffectingQuery(t2, e))).next((t3) => {
      for (const e2 of t3)
        for (const t4 of e2.mutations) {
          const n2 = t4.key;
          let i = s.get(n2);
          null == i && (i = te.newInvalidDocument(n2), s = s.insert(n2, i)), yn(t4, i, e2.localWriteTime), i.isFoundDocument() || (s = s.remove(n2));
        }
...
function io(t2, e, n) {
  ...
  return n.forEach((t3) => s = s.add(t3)), e.getEntries(t2, s).next((t3) => {
    ...
    return n.forEach((n2, i) => {
      const r = t3.get(n2);
      i.isNoDocument() && i.version.isEqual(ct.min()) ? (e.removeEntry(n2, i.readTime), s2 = s2.insert(n2, i)) : !r.isValidDocument() || i.version.compareTo(r.version) > 0 || 0 === i.version.compareTo(r.version) && r.hasPendingWrites ? (e.addEntry(i), s2 = s2.insert(n2, i)) : O2("LocalStore", "Ignoring outdated watch update for ", n2, ". Current version:", r.version, " Watch version:", i.version);
    }), s2;
  });
}
function ro(t2, e) {
  const n = G(t2);
  return n.persistence.runTransaction("Get next mutation batch", "readonly", (t3) => (void 0 === e && (e = -1), n.$s.getNextMutationBatchAfterBatchId(t3, e)));
}
function oo(t2, e) {
  const n = G(t2);
  return n.persistence.runTransaction("Allocate target", "readwrite", (t3) => {
    ...
    return (null === s || t3.snapshotVersion.compareTo(s.snapshotVersion) > 0) && (n.si = n.si.insert(t3.targetId, t3), n.ii.set(e, t3.targetId)), t3;
  });
}
...
function ao(t2, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t3) => function(t4, e2, n2) {
    ...
    return void 0 !== i2 ? wi.resolve(s2.si.get(i2)) : s2.ls.getTargetData(e2, n2);
  }(s, t3, Le(e)).next((e2) => {
    if (e2)
...
function ho(t2, e) {
  ...
  return n.persistence.runTransaction("Get new document changes", "readonly", (t3) => n.oi.getAllFromCollectionGroup(
    t3,
    e,
    oe(s, -1),
    Number.MAX_SAFE_INTEGER
  )).then((t3) => (lo(n, e, t3), t3));
}
function lo(t2, e, n) {
  let s = ct.min();
  n.forEach((t3, e2) => {
...
var mo = class {
  ...
  removeOverlaysForBatchId(t2, e, n) {
    ...
    return void 0 !== s && (s.forEach((t3) => this.overlays = this.overlays.remove(t3)), this.mi.delete(n)), wi.resolve();
  }
  getOverlaysForCollection(t2, e, n) {
  ...
  getOverlaysForCollectionGroup(t2, e, n, s) {
    ...
    for (; r.hasNext(); ) {
      ...
      if (t3.getKey().getCollectionGroup() === e && t3.largestBatchId > n) {
        ...
        null === e2 && (e2 = Qn(), i = i.insert(t3.largestBatchId, e2)), e2.set(t3.getKey(), t3);
      }
    }
...
var po = class {
  ...
  removeMutationBatch(t2, e) {
    U2(0 === this.Ni(e.batchId, "removed")), this.$s.shift();
    let n = this.Si;
...
var Eo = class {
  ...
  removeTargets(t2, e, n) {
    ...
    return this.Oi.forEach((r, o) => {
      o.sequenceNumber <= e && null === n.get(o.targetId) && (this.Oi.delete(r), i.push(this.removeMatchingKeysForTargetId(t2, o.targetId)), s++);
    }), wi.waitFor(i).next(() => s);
  }
  getTargetCount(t2) {
...
var So = class {
  ...
  static Ji(t2, e, n) {
    ...
    return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new Q2(s.error.code, s.error.message))), r ? new So(t2, e, s.state, i) : (F2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  Yi() {
    const t2 = {
      state: this.state,
...
var Do = class {
  ...
  static Ji(t2, e) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (s = new Q2(n.error.code, n.error.message))), i ? new Do(t2, n.state, s) : (F2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  Yi() {
    const t2 = {
      state: this.state,
...
var xo = class {
  ...
  static Ji(t2) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new xo(e.clientId, e.onlineState) : (F2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var No = class {
  constructor() {
...
var ko = class {
  ...
  Vr(t2, e) {
    const n = this.cr.exec(t2), s = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
    ...
    return y2(a, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (i2) {
          ...
          void 0 === e3 && (e3 = K2.INTERNAL, n3 = "Unknown error status: " + t4 + " with message " + i2.message), h = true, l2.eo(new Q2(e3, n3)), a.close();
        } else
...
var Qo = class {
  ...
  async close(t2, e) {
    this.Fo(), this.$o(), this.So.cancel(), this.Po++, 4 !== t2 ? this.So.reset() : e && e.code === K2.RESOURCE_EXHAUSTED ? (F2(e.toString()), F2("Using maximum backoff delay to prevent overloading the backend."), this.So.po()) : e && e.code === K2.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.Bo(), this.stream.close(), this.stream = null), this.state = t2, await this.listener.Jr(e);
  }
  Bo() {
  }
  auth() {
...
var zo = class extends class {
  ...
  ro(t2, e, n) {
    return this.tu(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, i]) => this.bo.ro(t2, e, n, s, i)).catch((t3) => {
      throw "FirebaseError" === t3.name ? (t3.code === K2.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t3) : new Q2(K2.UNKNOWN, t3.toString());
    });
  }
  co(t2, e, n) {
...
var Ho = class {
  ...
  uu(t2) {
    "Online" === this.state ? this.ru("Unknown") : (this.eu++, this.eu >= 1 && (this.au(), this.ou(`Connection failed 1 times. Most recent error: ${t2.toString()}`), this.ru("Offline")));
  }
  set(t2) {
    this.au(), this.eu = 0, "Online" === t2 && (this.su = false), this.ru(t2);
  }
  ru(t2) {
...
function tu(t2, e) {
  const n = G(t2), s = Au(n);
  n.hu.delete(e), s.Co() && nu(n, e), 0 === n.hu.size && (s.Co() ? s.ko() : ru(n) && n._u.set("Unknown"));
}
function eu(t2, e) {
...
var bu = class {
  ...
  cancel(t2) {
    null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new Q2(K2.CANCELLED, "Operation cancelled" + (t2 ? ": " + t2 : ""))));
  }
  handleDelayElapsed() {
...
var Ku = class {
  ...
  Yu() {
    return Su.fromInitialDocuments(this.query, this.Uu, this.mutatedKeys, 0 === this.$u);
  }
};
var Qu = class {
  constructor(t2, e, n) {
...
async function zu(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await Hu(n, e, s, "current" === r2);
  }
  return i;
}
async function Hu(t2, e, n, s) {
  t2.ha = (e2, n2, s2) => async function(t3, e3, n3, s3) {
    ...
    i2.ei && (i2 = await ao(
      ...
      e3.query,
      false
    ).then(({ documents: t4 }) => e3.view.Gu(t4, i2)));
  ...
  const i = await ao(
    ...
    e,
    true
  ), r = new Ku(e, i.hi), o = r.Gu(i.documents), u = Xn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t2.onlineState), a = r.applyChanges(
    o,
    t2.isPrimaryClient,
    u
  );
...
async function Ju(t2, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) || await uo(
      n.localStore,
      s.targetId,
      false
    ).then(() => {
    ...
    const t3 = await function(t4, e2) {
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (t5) => n2.ai.qs(t5, i).next((i2) => {
        ...
        for (const t6 of e2) {
          ...
          null != e3 && o.push(new An(t6.key, e3, Zt(e3.value.mapValue), _n.exists(true)));
        }
  ...
  try {
    const t3 = await function(t4, e2) {
      ...
      return n2.persistence.runTransaction("Reject batch", "readwrite-primary", (t5) => {
        let s2;
        return n2.$s.lookupMutationBatch(t5, e2).next((e3) => (U2(null !== e3), s2 = e3.keys(), n2.$s.removeMutationBatch(t5, e3))).next(() => n2.$s.performConsistencyCheck(t5)).next(() => n2.ai.qs(t5, s2));
      });
    }(s.localStore, e);
...
function ua2(t2, e) {
  ...
  const n = t2.sa.get(e);
  null !== n && (tu(t2.remoteStore, n), t2.sa = t2.sa.remove(e), t2.ia.delete(n), ha2(t2));
}
function aa2(t2, e, n) {
  for (const s of n)
    if (s instanceof qu)
...
async function ma2(t2, e, n, s) {
  ...
  null !== r ? ("pending" === n ? await fu(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (ra2(i, e, s || null), ia2(i, e), function(t3, e2) {
    G(G(t3).$s).dn(e2);
  }(i.localStore, e)) : L2(), await la2(i, r)) : O2("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
async function ga(t2, e) {
  const n = G(t2);
  if (Aa2(n), Ra2(n), true === e && true !== n.ca) {
    const t3 = n.sharedClientState.getAllActiveQueryTargets(), e2 = await ya2(n, t3.toArray());
    n.ca = true, await Eu(n.remoteStore, true);
    for (const t4 of e2)
      Zo(n.remoteStore, t4);
  } else if (false === e && false !== n.ca) {
    const t3 = [];
    let e2 = Promise.resolve();
    n.ea.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (oa2(n, i), uo(
        n.localStore,
        i,
        true
      ))), tu(n.remoteStore, i);
...
async function ya2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      e2 = await oo(s.localStore, n3), await Hu(
        s,
        pa2(n3),
        t3,
        false
...
async function Ta(t2, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t3 = await ho(i.localStore, je(r[0])), s2 = Yn.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
        await la2(i, t3, s2);
        break;
      }
      case "rejected":
...
var Va2 = class extends Pa {
  ...
  _a(t2) {
    const e = zr(t2.databaseInfo.databaseId, t2.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? _r.withCacheSize(this.cacheSizeBytes) : _r.DEFAULT;
...
var Sa2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(
      e,
      !t2.synchronizeTabs
    ), this.sharedClientState.onlineStateHandler = (t3) => Zu(this.syncEngine, t3, 1), this.remoteStore.remoteSyncer.handleCredentialChange = fa2.bind(null, this.syncEngine), await Eu(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await ao(
        ...
        e2,
        true
      ), i = new Ku(e2, s.hi), r = i.Gu(s.documents), o = i.applyChanges(
        r,
        false
      );
...
function Ja2(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new Ca2({
      next: (n3) => {
        e2.enqueueAndForget(() => Nu(t3, o)), n3.fromCache && "server" === s2.source ? i.reject(new Q2(K2.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new Fu(n2, r, {
      includeMetadataChanges: true,
...
var hc2 = class {
  ...
  _setSettings(t2) {
    ...
    this._settings = new cc2(t2), void 0 !== t2.credentials && (this._authCredentials = function(t3) {
      if (!t3)
        return new z2();
      switch (t3.type) {
        case "gapi":
...
var _c = class extends dc2 {
  ...
  get parent() {
    ...
    return t2.isEmpty() ? null : new fc2(
      this.firestore,
      null,
      new xt(t2)
    );
...
function gc2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), 1 === arguments.length && (e = it.R()), nc2("doc", "path", e), t2 instanceof hc2) {
    const s = _t.fromString(e, ...n);
    return ic2(s), new fc2(
      t2,
      null,
      new xt(s)
    );
...
var Ic2 = class {
  constructor() {
    ...
    const t2 = qo();
    t2 && "function" == typeof t2.addEventListener && t2.addEventListener("visibilitychange", this.Ua);
  }
  get isShuttingDown() {
    return this.Ma;
  }
...
function Sc2(t2, e) {
  ...
  return Cc2(n, i, new Va2(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
function Dc2(t2) {
  Bc2(t2 = uc2(t2, Rc2));
...
var jc2 = class {
  ...
  toMutation(t2, e) {
    return null !== this.fieldMask ? new An(t2, this.data, this.fieldMask, e, this.fieldTransforms) : new En(t2, this.data, e, this.fieldTransforms);
  }
};
var Wc2 = class {
  constructor(t2, e, n) {
...
var Hc2 = class {
  constructor(t2, e, n, s, i, r) {
    this.settings = t2, this.databaseId = e, this.M = n, this.ignoreUndefinedProperties = s, void 0 === i && this.Ja(), this.fieldTransforms = i || [], this.fieldMask = r || [];
  }
  get path() {
  ...
  Za(t2) {
    var e;
    const n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t2), s = this.Xa({
      path: n,
      tc: false
    });
    return s.ec(t2), s;
...
var Zc2 = class extends Gc2 {
  _toFieldTransform(t2) {
    if (2 !== t2.Ya)
      throw 1 === t2.Ya ? t2.ic(`${this._methodName}() can only appear at the top level of your update data`) : t2.ic(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var nh = class extends Gc2 {
  ...
  _toFieldTransform(t2) {
    const e = th(
      ...
      t2,
      true
    ), n = this.ac.map((t3) => ah(t3, e)), s = new sn(n);
...
var sh = class extends Gc2 {
  ...
  _toFieldTransform(t2) {
    const e = th(
      ...
      t2,
      true
    ), n = this.ac.map((t3) => ah(t3, e)), s = new on(n);
    return new ln(t2.path, s);
  }
  isEqual(t2) {
    return this === t2;
...
function hh(t2) {
  return !("object" != typeof t2 || null === t2 || t2 instanceof Array || t2 instanceof Date || t2 instanceof at || t2 instanceof Kc2 || t2 instanceof qc2 || t2 instanceof fc2 || t2 instanceof Gc2);
}
function lh(t2, e, n) {
  if (!hh(n) || !function(t3) {
    ...
    const s = oc2(n);
    throw "an object" === s ? e.ic(t2 + " a custom object") : e.ic(t2 + " " + s);
  }
}
function fh(t2, e, n) {
...
function ph(t2, e) {
  return "string" == typeof e ? _h(t2, e) : e instanceof Lc2 ? e._internalPath : e._delegate._internalPath;
}
var Ih = class {
  constructor(t2, e) {
  ...
  _apply(t2) {
    const e = Yc2(t2.firestore), n = function(t3, e2, n2, s, i, r, o) {
      ...
      if (i.isKeyField()) {
        ...
        "in" !== r && "not-in" !== r && "array-contains-any" !== r || Kh(o, r), u = uh(
          n2,
          e2,
          o,
          "in" === r || "not-in" === r
...
var Hh = class {
  ...
  set(t2, e, n) {
    ...
    const s = Jh(t2, this._firestore), i = Wh(s.converter, e, n), r = Xc2(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
  ...
  update(t2, e, n, ...s) {
    ...
    let r;
    return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Lc2 ? oh(this._dataReader, "WriteBatch.update", i._key, e, n, s) : rh(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, _n.exists(true))), this;
  }
  delete(t2) {
    this._verifyNotCommitted();
...
function Zh(t2) {
  ...
  return Wa2(n, t2._key).then((n2) => new Th(e, s, t2._key, n2, new Ih(
...
function il(t2, e, n) {
  ...
  return hl(s, [Xc2(Yc2(s), "setDoc", t2._key, i, null !== t2.converter, n).toMutation(t2._key, _n.none())]);
}
function rl(t2, e, n, ...s) {
  t2 = uc2(t2, fc2);
  const i = uc2(t2.firestore, Rc2), r = Yc2(i);
  let o;
  o = "string" == typeof (e = getModularInstance(e)) || e instanceof Lc2 ? oh(r, "updateDoc", t2._key, e, n, s) : rh(r, "updateDoc", t2._key, e);
...
function ul(t2, e) {
  ...
  return hl(n, [Xc2(Yc2(t2.firestore), "addDoc", s._key, i, null !== t2.converter, {}).toMutation(s._key, _n.exists(false))]).then(() => s);
}
function al(t2, ...e) {
  var n, s, i;
  t2 = getModularInstance(t2);
  ...
  "object" != typeof e[o] || Tc2(e[o]) || (r = e[o], o++);
  const u = {
...
var fl = class extends class {
  ...
  set(t2, e, n) {
    const s = Jh(t2, this._firestore), i = Wh(s.converter, e, n), r = Xc2(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    return this._transaction.set(s._key, r), this;
  }
  update(t2, e, n, ...s) {
    const i = Jh(t2, this._firestore);
    let r;
    return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Lc2 ? oh(this._dataReader, "Transaction.update", i._key, e, n, s) : rh(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  delete(t2) {
    const e = Jh(t2, this._firestore);
  ...
  get(t2) {
    ...
    return super.get(t2).then((t3) => new Th(this._firestore, n, e._key, t3._document, new Ih(
      false,
      false
    ), e.converter));
  }
    ...
    for (const t3 of n.indexes) {
      ...
      if (Array.isArray(t3.fields))
        for (const e3 of t3.fields) {
          ...
          "CONTAINS" === e3.arrayConfig ? n2.push(new ie(t4, 2)) : "ASCENDING" === e3.order ? n2.push(new ie(t4, 0)) : "DESCENDING" === e3.order && n2.push(new ie(t4, 1));
        }
